...
private fun turnsToKill(attacker: RPGChar, defender: RPGChar) =
        turnsToKill(attacker.damage, defender.health)

private fun turnsToKill(attack: Int, health: Int) = Math.ceil(health.toDouble() / attack).toInt()
